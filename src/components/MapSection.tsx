function MapSection() {
  return (
    ...
    >
      <div
        className="xl:w-[700px] w-full xl:h-[440px] h-[240px] bg-base xl:rounded-[18px] rounded-[10px] overflow-hidden"
        data-aos="fade-right"
      >
        <iframe
      ...
      <div
        className="w-[370px] flex flex-col gap-[20px] text-center xl:text-start"
        data-aos="fade-left"
      >
